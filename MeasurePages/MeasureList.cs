...
namespace CalcYouLate.Functionality
{
    public class MeasureList
    {
        ...
        public static Dictionary<string, double> timeToHrs = new Dictionary<string, double>()
        {
            {"наносекунда", 0.000000000000000278 },
            {"миллисекунда", 0.0000036 },
            {"секунда", 0.000036 },
            {"минута", 0.06 },
            {"час", 1 },
            {"сутки", 24 },
            {"неделя", 168 },
            {"григорианский год", 8760 },
            {"юлианский год", 8766 },
            {"драконический год", 8760 },
            {"век", 876000 }
        };

        public static Dictionary<string, double> timeFromHours = new Dictionary<string, double>()
        {
            {"наносекунда", 1.0 / 0.000000000000000278 },
            {"миллисекунда", 1.0 / 0.0000036 },
            {"секунда",1.0 /  0.000036 },
            {"минута", 1.0 / 0.06 },
            {"час", 1 },
            {"сутки", 1.0 / 24 },
            {"неделя", 1.0 / 168 },
            {"григорианский год", 1.0 / 8760 },
            {"юлианский год", 1.0 / 8766 },
